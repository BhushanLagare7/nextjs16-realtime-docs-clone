...
| **Dashboard & Templates**            | [`docs/dashboard-home.md`](docs/dashboard-home.md)                                   | Home route layout, search input with nuqs, and template gallery carousel                       |
...
| **Database & Backend**               | [`docs/database-conventions.md`](docs/database-conventions.md)                       | Convex architecture overview, client setup, schema definition, and indexing                    |
| **Database (Mutations & Auth)**      | [`docs/database-mutations.md`](docs/database-mutations.md)                           | CRUD mutations, pagination queries, multi-tenancy invariants, and authorization guard pattern  |
...
| **Theming (Integrations)**           | [`docs/theming-integrations.md`](docs/theming-integrations.md)                       | Liveblocks UI dual-stylesheet, Clerk `shadcn` theme binding, and Sonner toast theming          |
